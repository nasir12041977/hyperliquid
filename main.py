...
# आपका वो जबरदस्त 'सुभानल्लाह' वाला डैशबोर्ड
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="hi">
<head>
    ...
    <style>
        ...
        .meaning { font-size: 1.2rem; padding-left: 25px; color: #888; letter-spacing: 1px; }
...
<body>
    <div class="aqdas-container">
        ...
        <div class="logic-list">
            <div class="logic-row">
                <div class="initial">A</div><div class="word">ADAL (अदल)</div>
                <div class="meaning">: ANALYSIS & DATA ARCHIVE LOGIC</div>
            </div>
            <div class="logic-row">
                <div class="initial">Q</div><div class="word">QADR (क़द्र)</div>
                <div class="meaning">: QUALITY CHECK & DEPLOYMENT RATING</div>
            </div>
            <div class="logic-row">
                <div class="initial">D</div><div class="word">DASTAK (दस्तक)</div>
                <div class="meaning">: DATA ANALYSIS & STRATEGY TRACKING</div>
            </div>
            <div class="logic-row">
                <div class="initial">A</div><div class="word">AMAL (अमल)</div>
                <div class="meaning">: ASSET MATCHING & ARBITRATION LOGIC</div>
            </div>
            <div class="logic-row">
                <div class="initial">S</div><div class="word">SAFEER (सफ़ीर)</div>
                <div class="meaning">: SECURE AUDIT & FINAL EXECUTION REPORT</div>
            </div>
        </div>
    </div>
    <div class="dashboard">
        <div class="card"><span class="card-label">EQUITY</span><div class="card-value">$42,500.85</div></div>
        <div class="card"><span class="card-label">CANDLE DATA</span><div class="card-value">14,400 PTS</div></div>
        <div class="card"><span class="card-label">NET QTY (DASTAK)</span><div class="card-value highlight">+1.45820</div></div>
        <div class="card"><span class="card-label">GAP (SAFEER)</span><div class="card-value" style="color: #00ff00;">0.00000</div></div>
    </div>
</body>
</html>
"""
...
if __name__ == "__main__":
    # रेंडर के लिए पोर्ट सेट करना बहुत ज़रूरी है
